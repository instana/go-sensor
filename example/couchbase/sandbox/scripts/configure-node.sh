...
#
# The content in this file, along with the create-index.json file located in the same directory(../scripts), 
# has been copied from the Couchbase Server Sandbox repository.
#
# Original file location and the commit hash : https://github.com/couchbase/server-sandbox/tree/ff41f2e548206df35dd2daa26b748126c4cc9824/scripts
#
# It is used solely for the purpose of demonstrating a working example of Go code with sandbox data in Couchbase. 
# The original copyright for these files remains with the original authors of the repository mentioned above.
